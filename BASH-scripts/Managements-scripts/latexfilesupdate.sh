...
BIBLIOGRAPHYPATH="$HOME/GitHub-repositories/Writing-repositories/Nauki-rozne-bledy-i-uwagi/Bibliografia"
...
####################
# DEUS directory path
DEUSPHILOSOPHYPATH="$VARIOUSSCIENCESPATH/DEUS-błędy-i-uwagi"
####################
